  ...
  return (
    <>
      <footer className="container-fluid py-5 custom-bg-contact">
            ...
            <div className="col-12 col-md-6">
              ...
              >
                ...
                <textarea
                  ...
                  required
                />
                <button type="submit" className="btn custom-btn w-100 w-md-auto">
                  Submit Inquiry
                </button>
              </form>
        ...
        <div className="container d-flex flex-wrap justify-content-center align-items-center gap-5 text-dark mt-5">
          <div className="reference d-flex flex-wrap justify-content-center align-items-center gap-3 text-center">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="30"
              height="30"
              fill="currentColor"
              class="bi bi-geo-alt bold"
              viewBox="0 0 16 16"
            >
          ...
          <hr />
          <div className="icon text-center text-center w-50 pb-0 mb-0">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="30"
              height="30"
            ...
            <div className="reference pt-2">
              +91 9824617016 <br />+91 9925090247
            </div>
          </div>
        </div>
      </footer>
